...
const clients = [
  ...
  },
  {
    ...
    nameKo: "서울대학교",
    category: "대학교",
    description: "국내 최고의 종합 국립대학교. 연구 및 실험용 정밀 시험편·장비 납품.",
    logoSrc: "/img/logo_snu.png",
  },
  {
    name: "KAIST",
    nameKo: "한국과학기술원",
    category: "대학교",
    description: "이공계 특수목적 국립대학. 첨단 연구용 정밀 시험편 및 기기 납품.",
    logoSrc: "/img/logo_kaist.png",
  },
  {
    name: "Hanyang University",
    nameKo: "한양대학교",
    category: "대학교",
    description: "서울·ERICA 캠퍼스 보유 종합대학교. 실험 및 연구용 정밀 시험편 납품.",
    logoSrc: "/img/logo_hanyang.png",
  },
  {
    name: "Chung-Ang University",
    nameKo: "중앙대학교",
    category: "대학교",
    description: "서울 소재 종합대학교. 실험실 연구용 시험편·시험기기 납품.",
    logoSrc: "/img/logo_chungang.png",
  },
  {
    name: "Hongik University",
    nameKo: "홍익대학교",
    category: "대학교",
    description: "서울 소재 종합대학교. 연구 및 실험용 정밀 부품·시험편 납품.",
    logoSrc: "/img/logo_hongik.png",
  },
  {
  ...
  },
  {
    ...
    nameKo: "순천향대학교",
    category: "대학교",
    description: "충남 아산 소재 종합대학교. 의료·공학 연구용 정밀 시험편 납품.",
    logoSrc: "/img/logo_soonchunhyang.png",
  },
  {
    name: "Hoseo University",
    nameKo: "호서대학교",
    category: "대학교",
    description: "충남 아산·천안 소재 종합대학교. 공학 연구용 정밀 부품·시험편 납품.",
    logoSrc: "/img/logo_hoseo.png",
  },
  {
    name: "Korea University of Technology and Education",
    nameKo: "한국공과대학교",
    category: "대학교",
    description: "충남 천안 소재 공과계 특수목적대학(KOREATECH). 실험·연구용 시험편 납품.",
    logoSrc: "/img/logo_koreatech.png",
  },
];
